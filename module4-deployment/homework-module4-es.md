## Homework - Module 4 - Exequiel Santucho
...
**Answer**: `!jupyter nbconvert --to script homework.ipynb --output homework`
...
Build image: `docker build -t taxi-duration-predictor .`
Run image: `docker run --rm taxi-duration-predictor --year 2023 --month 5`
