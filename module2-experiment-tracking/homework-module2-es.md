## Homework - Module 2 - Exequiel Santucho
...
- mlflow gc --backend-store-uri sqlite:////path/to/mlflow.db --experiment-ids 42 (for permanent deleting experiment)
- 
## Q1. Install MLflow
...
**Answer**: 2
I tried run train.py with autolog and without autolog control.
...
**Answer**: --default-artifact-root (required if not using local mode)
